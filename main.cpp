...

  {
...

    {
...

      {
        ...
        signal_[i] = (float) atof(serialInBuffer);
...

{
...

  {
    ...
    waveform[i] = (int16_t) (signal_[(uint16_t) (i * freq * signalLength * 1. / kAudioSampleFrequency) % signalLength]);
